...
namespace HJ_Template_MVC.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ReportController : HJ_Template_MVC.Controllers.ReportController
    {
        ...
        [NonAction]
        partial void GetFactorOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, ViewModels.Watch.FactorViewModel factor, int pageIndex, int pageSize);

        [NonAction]
        public override System.Web.Mvc.JsonResult GetFactor(ViewModels.Watch.FactorViewModel factor, int pageIndex, int pageSize)
        {
            ...
            GetFactorOverride(callInfo, factor, pageIndex, pageSize);
            return callInfo;
        }
