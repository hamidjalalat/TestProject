...
namespace HJ_Template_MVC.Controllers
{
    public partial class UsersController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.JsonResult CreateAjax()
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.CreateAjax);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _Partial_GeneralDialog = "_Partial_GeneralDialog";
                public readonly string Create = "Create";
                public readonly string Delete = "Delete";
                public readonly string Details = "Details";
                public readonly string Edit = "Edit";
            ...
            public readonly string _Partial_GeneralDialog = "~/Views/Users/_Partial_GeneralDialog.cshtml";
    ...
    public partial class T4MVC_UsersController : HJ_Template_MVC.Controllers.UsersController
    {
        ...
        [NonAction]
        partial void CreateAjaxOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, Models.User user);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ViewModels.Users.CreateViewModel user);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(ViewModels.Users.CreateViewModel user)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "user", user);
