...
namespace HJ_Template_MVC.Controllers
{
    ...
    public partial class T4MVC_AccountController : HJ_Template_MVC.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void CheckUsernameOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, string name);

        [NonAction]
        public override System.Web.Mvc.JsonResult CheckUsername(string name)
        {
